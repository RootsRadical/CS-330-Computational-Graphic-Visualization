...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"../../Utilities/textures/penil_cup.jpg",
		"pencil");

	bReturn = CreateGLTexture(
		"../../Utilities/textures/computer_monitor.jpg",
		"computer");
}
...
void SceneManager::RenderScene()
{
	...
	SetShaderColor(1.0f, 1.0f, 1.0f, 1.0f); // White color for the background
	m_basicMeshes->DrawPlaneMesh();

	// Draw the floor plane (rotated to lie flat)
	scaleXYZ = glm::vec3(20.0f, 1.0f, 10.0f);
	XrotationDegrees = 90.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, -9.0f, -10.0f); // Move it down below the background
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	...
	// Draw a red cube
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.0f);  // Cube size
	XrotationDegrees = 0.0f;
	YrotationDegrees = 45.0f;  // Rotate for a better view
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-3.0f, 0.5f, -5.0f);  // Position the cube
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(1.0f, 0.0f, 0.0f, 1.0f);  // Red color for the cube
	m_basicMeshes->DrawBoxMesh();  // Draw the cube mesh

	// Draw a cylinnder
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.0f);  // Cylinder size
	XrotationDegrees = 0.0f;
	YrotationDegrees = 45.0f;  // Rotate for a better view
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-5.0f, 0.7f, -5.0f);  // Position the cylinder
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(1.0f, 0.0f, 0.0f, 1.0f);  // color for the cube
	m_basicMeshes->DrawCylinderMesh();  // Draw the cylinder mesh

	// Draw a cone
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.0f);  // Cone size
	XrotationDegrees = 0.0f;
	YrotationDegrees = 45.0f;  // Rotate for a better view
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-5.0f, 0.7f, -5.0f);  // Position the cone
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(1.0f, 0.0f, 0.0f, 1.0f);  // color for the cube
	m_basicMeshes->DrawConeMesh();  // Draw the cone mesh

	// Draw a Sphere
	scaleXYZ = glm::vec3(1.0f, 1.0f, 1.0f);  // Sphere size
	XrotationDegrees = 0.0f;
	YrotationDegrees = 45.0f;  // Rotate for a better view
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-5.0f, 0.7f, -5.0f);  // Position the sphere
	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(1.0f, 0.0f, 0.0f, 1.0f);  // color for the cube
	m_basicMeshes->DrawConeMesh();  // Draw the sphere mesh
